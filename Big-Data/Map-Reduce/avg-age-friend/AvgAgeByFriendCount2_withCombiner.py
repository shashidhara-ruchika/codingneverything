"""
python AvgAgeByFriendCount2_withCombiner.py fakefriends.csv
"""
...
class MRAvgAgeByFriendCount2_withCombiner(MRJob):
    ...
    def combiner(self, age:str, no_of_friends:tuple) -> (str, float):
        ...
        for friend_count_json_str in no_of_friends:
            ...
            # for map value dump a dictionary with sum_friends as key & count_friends as value
            yield age, dumps({str(sum_friends) : count_friends}, skipkeys = True)
...
if __name__ == "__main__":
    MRAvgAgeByFriendCount2_withCombiner.run()
